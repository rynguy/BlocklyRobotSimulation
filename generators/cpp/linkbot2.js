...
Blockly.Cpp['linkbot_constructor_2'] = function(block) {
  Blockly.Cpp.definitions_['include_linkbot'] =
      '#include <linkbot.h>';
  return 'CLinkbotI robot1, robot2;\n';
};

Blockly.Cpp['linkbot_speed_2'] = function(block) {
  Blockly.Cpp.definitions_['include_linkbot'] =
      '#include <linkbot.h>';
...
Blockly.Cpp['linkbot_turn_2'] = function(block) {
  Blockly.Cpp.definitions_['include_linkbot'] =
      '#include <linkbot.h>';
  var dropdown_number = block.getFieldValue('number');
...
Blockly.Cpp['linkbot_drive_distance_2'] = function(block) {
  Blockly.Cpp.definitions_['include_linkbot'] =
      '#include <linkbot.h>';
...
Blockly.Cpp['linkbot_turn_2_NB'] = function(block) {
  Blockly.Cpp.definitions_['include_linkbot'] =
      '#include <linkbot.h>';
  var dropdown_number = block.getFieldValue('number');
  var dropdown_direction = block.getFieldValue('direction');
...
Blockly.Cpp['linkbot_drive_distance_2_NB'] = function(block) {
  Blockly.Cpp.definitions_['include_linkbot'] =
      '#include <linkbot.h>';
  Blockly.Cpp.definitions_['include_ch_math'] =
      '#include <math.h>';
