...
goog.provide('Blockly.Blocks.linkbot4');

goog.require('Blockly.Blocks');

Blockly.Blocks.linkbot4.HUE = 270;

Blockly.Blocks['linkbot4_speed_in'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
...
Blockly.Blocks['linkbot4_speed_cm'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
        .appendField("setSpeed(speed")
...
Blockly.Blocks['linkbot4_blink_LED'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['linkbot4_move_joints'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['linkbot4_move_wait'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['linkbot4_traceon'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
        .appendField("traceOn();");
...
Blockly.Blocks['linkbot4_traceoff'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['linkbot4_turn_in'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
        .appendField("turn")
...
Blockly.Blocks['linkbot4_turn_cm'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
        .appendField("turn")
...
Blockly.Blocks['linkbot4_drive_distance_in'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['linkbot4_drive_distance_cm'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
        .appendField("driveDistance(distance")
...
Blockly.Blocks['linkbot4_drive_time'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['linkbot4_drive_angle'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['linkbot4_turn_in_NB'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
        .appendField("turn")
...
Blockly.Blocks['linkbot4_turn_cm_NB'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
        .appendField("turn")
...
Blockly.Blocks['linkbot4_drive_distance_in_NB'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['linkbot4_drive_distance_cm_NB'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
        .appendField("driveDistanceNB(distance")
...
Blockly.Blocks['linkbot4_drive_time_NB'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['linkbot4_drive_angle_NB'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['linkbot4_reset_NB'] = {
  init: function() {
    this.setColour(Blockly.Blocks.linkbot4.HUE);
    this.appendDummyInput()
