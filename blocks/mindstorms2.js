...
Blockly.Blocks['mindstorms2_speed_in'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
...
Blockly.Blocks['mindstorms2_speed_cm'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
        .appendField("setSpeed(speed")
    ...
    this.appendDummyInput()
        .appendField("              radius")
        .appendField(new Blockly.FieldDropdown([["4.45", "4.445"], ["4.13", "4.13"], ["5.08", "5.08"]]), "radius")
        .appendField("cm);");
    this.setPreviousStatement(true, "null");
    this.setNextStatement(true, "null");
    this.setTooltip('');
...
Blockly.Blocks['mindstorms2_blink_LED'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['mindstorms2_delay'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['mindstorms2_move_joints'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['mindstorms2_move_wait'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['mindstorms2_traceon'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
        .appendField("traceOn();");
...
Blockly.Blocks['mindstorms2_traceoff'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['mindstorms2_turn_in'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
        .appendField("turn")
...
Blockly.Blocks['mindstorms2_turn_cm'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
        .appendField("turn")
...
Blockly.Blocks['mindstorms2_drive_distance_in'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['mindstorms2_drive_distance_cm'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
        .appendField("driveDistance(distance")
...
Blockly.Blocks['mindstorms2_drive_time'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['mindstorms2_drive_angle'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['mindstorms2_reset'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['mindstorms2_turn_in_NB'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
        .appendField("turn")
...
Blockly.Blocks['mindstorms2_turn_cm_NB'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
        .appendField("turn")
...
Blockly.Blocks['mindstorms2_drive_distance_in_NB'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['mindstorms2_drive_distance_cm_NB'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
        .appendField("driveDistanceNB(distance")
...
Blockly.Blocks['mindstorms2_drive_time_NB'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['mindstorms2_drive_angle_NB'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
...
Blockly.Blocks['mindstorms2_reset_NB'] = {
  init: function() {
    this.setColour(Blockly.Blocks.mindstorms2.HUE);
    this.appendDummyInput()
